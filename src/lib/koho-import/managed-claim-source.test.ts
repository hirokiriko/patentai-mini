...
describe("original parser to managed claim metadata", () => {
  ...
  it.each([
    ...
    ["請求項1～3のうちのいずれか1項記載の架空装置。", [1, 2, 3]],
    ["請求項1～3のうち何れか一項に記載の架空装置。", [1, 2, 3]],
    ["請求項1～3の内いずれか一項に記載の架空装置。", [1, 2, 3]],
    ["請求項1～3いずれか一項に記載の架空装置。", [1, 2, 3]],
    ["請求項1～3の少なくともいずれか一項に記載の架空装置。", [1, 2, 3]],
    ["請求項1、および請求項2に記載の架空装置。", [1, 2]],
